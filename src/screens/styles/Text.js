     ...
     auditRowLabel: {
       ...
       infoBadge: {
         ...
         chevron: {
            ...
            chipText: { fontSize: screen.isTablet ? Dimensions.text.submitTextFontSize :Dimensions.text.chipTextFontSize, 
        ...
        chipTextPiece:   { color: AppColors.error,fontFamily:'Inter-Bold' },
        ...
        chipTextAssignee:{ color: AppColors.primaryDark ,fontFamily:'Inter-Bold'},
        chipCap:         { backgroundColor: AppColors.chipCapBg, borderColor: AppColors.chipCapBorder,
          borderRadius:Dimensions.text.pieceDefectPadding },
        chipTextCap:     { color: AppColors.chipCapText ,fontFamily:'Inter-Bold'},
        ...
        chipTextMore:    { color: AppColors.textSecondary ,fontFamily:'Inter-Bold'},
        placeholderText: {
            fontSize: screen.isTablet ? Dimensions.text.sectionLabelFontSizeL : Dimensions.text.placeholderTextFontSize,
