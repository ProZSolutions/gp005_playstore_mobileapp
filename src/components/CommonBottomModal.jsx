...
export default function CommonBottomModal({ visible, onClose, title, ms = (n) => n, children }) {
   const {  moderateVerticalScale: mvs, fontScale: fs, isLargeScreen } = useResponsive();
...
const styles = StyleSheet.create({
  ...
  titleLarge: { fontSize: 18, fontWeight: '700', color: AppColors.textPrimary ?? '#222', flex: 1, marginRight: 12 },
  body: { flexShrink: 1 },
});